...
data class CHRemoveSignKeyRequest(var deviceId: String, var token: String, var secretKey: String)

internal data class CHSS2WebCMDReq(var cmd: UByte, var history: String, var sign: String)
